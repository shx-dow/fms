...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!--]--> <button type="submit"${attr("disabled", submitting, true)} class="svelte-1x05zx6">${escape_html("Sign in")}</button></form> <p class="support svelte-1x05zx6">For access assistance, contact your department administrator.</p></section> <footer class="svelte-1x05zx6">Internal university application · Academic year 2026–27</footer></main>`);
  });
}
export {
  _page as default
