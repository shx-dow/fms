...
<main class="shell app-shell review-shell">
  ...
  {:else}
    ...
    <div class="page-heading">
      ...
      <div style="display:flex;gap:8px;align-items:center"><span class="period-chip">{reports.length} report{reports.length === 1 ? '' : 's'}</span><a href="/api/reviews?format=csv" target="_blank" class="period-chip export-chip" style="text-decoration:none;cursor:pointer">CSV</a></div>
    </div>
