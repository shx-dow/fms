...
<style>
  ...
  .rp-head { display: flex; justify-content: space-between; align-items: center; gap: 15px; padding: 18px 20px; border-bottom: 1px solid #dbe3e7; }
  .rp-head-info h2 { font-size: 1.1rem; letter-spacing: -0.02em; margin: 0; }
  .rp-head-meta { font-size: 0.78rem; color: #667477; }
  .rp-tabs { display: flex; border-bottom: 1px solid #dbe3e7; }
  .rp-tabs button { border: 0; background: 0; padding: 10px 18px; font: inherit; font-size: 0.78rem; color: #667477; cursor: pointer; border-bottom: 2px solid transparent; transition: all 0.12s; }
  .rp-tabs button.active { color: #145b78; font-weight: 700; border-bottom-color: #145b78; }
  .rp-body { padding: 20px; }
  .rp-label { display: block; font-size: 0.74rem; font-weight: 700; color: #667477; margin-bottom: 6px; }
  .rp-reviews { margin-bottom: 18px; }
  .rp-reviews h3, .rp-body h3 { font-size: 0.8rem; margin: 0 0 10px; color: #1b2b36; }
  .rp-rv-row { display: flex; align-items: center; gap: 10px; padding: 8px 0; border-bottom: 1px solid #e8eeec; font-size: 0.8rem; }
  .rp-rv-row:last-child { border-bottom: 0; }
  .rv-text { color: #667477; font-size: 0.78rem; }
  .rv-text strong { color: #1b2b36; }
  ...
  .btn-changes { background: #e09080; color: #7a3028; }
  .btn-changes:hover { background: #d47c6c; }
